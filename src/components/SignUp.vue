        ...
        <div class="form-signin">
            <form class="text-center">
                ...
                <div class="form-floating mb-2">
                    <input type="email" class="form-control border-input-important border-bottom" id="floatingInput" placeholder="Username">
                    <label for="floatingInput">Username</label>
                </div>
                <div class="form-floating mb-2">
                    <input type="password" class="form-control border-input-important border-bottom" id="floatingPassword" placeholder="Password">
                    <label for="floatingPassword">Password</label>
                </div>

                <div class="form-floating mb-2">
                    <input type="firstname" class="form-control border-input-important border-bottom" id="floatingInput" placeholder="First Name">
                    <label for="floatingInput">First Name</label>
                </div>

                <div class="form-floating mb-3">
                    <input type="lastname" class="form-control border-input-important border-bottom" id="floatingInput" placeholder="Last Name">
